...
<form method="POST" action="{{ route('admin.sub-categories.update', $subcategory->id) }}">
    	...
    	<div class="row mb-5">
			...
			<div class="col-md-6">
				<select id="category" class="form-control @error('category_id') is-invalid @enderror" name="category_id" required>
					...
					<option class="text-primary" value="{{ $category->id }}">{{ $category->name }}</option>
					@endif
					@endforeach
					@foreach($categories as $category)
					@if( $category->id != $subcategory->category_id)
		...
		<div class="row mb-2">
			...
			<div class="col-md-6">
                ...
                name="name_en" value="{{ $subcategory->name_en }}" required>
            </div>
			<div class="col-md-3"></div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6">
                ...
                name="name_fr" value="{{ $subcategory->name_fr }}" required>
            </div>
			<div class="col-md-3"></div>
			@error('name_fr')
			<div class="col-md-3"></div>
		...
		<div class="row mb-5">
            ...
            <div class="col-md-6">
                ...
                name="name_ar" value="{{ $subcategory->name_ar }}" required>
            </div>
			<div class="col-md-3"></div>
			@error('name_ar')
			<div class="col-md-3"></div>
		...
		<div class="row mb-2">
            ...
            <div class="col-md-6">
                ...
                name="title_en" value="{{ $subcategory->title_en }}" placeholder="{{ $subcategory->name_en }}">
            </div>
			<div class="col-md-3"></div>
			@error('title_en')
			<div class="col-md-3"></div>
		...
		<div class="row mb-2">
            ...
            <div class="col-md-6">
                ...
                name="title_fr" value="{{ $subcategory->title_fr }}" placeholder="{{ $subcategory->name_fr }}">
            </div>
			<div class="col-md-3"></div>
			@error('title_fr')
			<div class="col-md-3"></div>
		...
		<div class="row mb-5">
            ...
            <div class="col-md-6">
                ...
                name="title_ar" value="{{ $subcategory->title_ar }}" placeholder="{{ $subcategory->name_ar }}">
            </div>
			<div class="col-md-3"></div>
			@error('title_ar')
			<div class="col-md-3"></div>
		...
		<div class="row mb-2">
            ...
            <div class="col-md-6">
                ...
                name="description_en" rows="3">{{ $subcategory->description_en }}</textarea>
            </div>
			<div class="col-md-3"></div>
		...
		<div class="row mb-2">
            ...
            <div class="col-md-6">
                ...
                name="description_fr" rows="3">{{ $subcategory->description_fr }}</textarea>
            </div>
			<div class="col-md-3"></div>
		...
		<div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                name="description_ar" rows="3">{{ $subcategory->description_ar }}</textarea>
            </div>
			<div class="col-md-3"></div>
        ...
        <div class="row mb-4">
			...
			<div class="col-md-6 d-flex bg-white border" style="margin-inline-start: 0.75rem; flex: 0;">
            	...
            	<label class="switch mx-2">
					  <input id="visibility" type="checkbox" name="visibility" {{ $subcategory->visibility == 1 ? 'checked' : '' }}>
